...
struct MronValue {
    using Variant = std::variant<std::nullptr_t, bool, long long, double, std::string, MronArray, MronObject>;
    Variant value;
...
using MrtdCell = std::variant<std::string, long long, double, bool>;
